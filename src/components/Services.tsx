  ...
  const services = [
    {
      ...
      description:
        "We offer comprehensive plumbing solutions to keep your water systems running smoothly",
      items: [
    ...
    },
    {
      ...
      description:
        "Keep your property safe and efficient with our expert electrical services:",
      items: [
    ...
    },
    {
      ...
      description:
        "Our team provides a range of maintenance services to enhance and protect your property:",
      items: [
        "Handyman services",
        ...
        <div className="text-center mb-12">
          <div className="inline-block">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Philadelphia's <span className="text-primary">24/7</span> Plumbing
              & Electrical Experts
            </h2>
          </div>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mt-4">
            ...
            <strong>
              Plumbing, Electrical, and General Maintenance services
            </strong>{" "}
            in Philadelphia, PA.{" "}
            <Link
              to="/contact"
          ...
          <p className="text-muted-foreground mt-2">
            With years of experience and a passion for excellence, we are here
